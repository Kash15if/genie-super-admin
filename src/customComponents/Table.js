...
import { getInputBoxFromType } from "./editTable";
// Import Style
...
const CRUDIE = ({
  ...
  const onUpdateConfirm = async () => {
    console.log("onUpdateConfirms", selectedOneRowForEdit);
    try {
      await axios.post(
  ...
  return (
    <div className={CrudieStyle.MfgdrfainBody}>
      <div className={CrudieStyle.frame}>
        <div className={CrudieStyle.Toolbar}>
          <div className={CrudieStyle.ToolbarLeft}>
            ...
            <button
              ...
              onClick={() => {
                if (Object.keys(multiSelectForDeleteList).length !== 0)
                  setSelectedMultipleRowForDeletePopup(true);
              }}
            >
          ...
          <div className={CrudieStyle.modal}>
            <div className={CrudieStyle.modalcontent}>
              ...
              <div className={CrudieStyle.PopupFooter}>
                {createNewRecordFormOpen ? (
                  <button
                    className={CrudieStyle.button33}
                ...
                <button
                  className={CrudieStyle.button34}
            ...
            <div className={CrudieStyle.modal}>
              <div className={CrudieStyle.modalcontent}>
                ...
                <div className={CrudieStyle.DeleteBtnAlign}>
                  <button
                    className={CrudieStyle.PopupDelBtn}
                    onClick={() => onDeleteConfirm(selectedOneRowForDelete)}
                  >
                    Delete
                  </button>
                  <button
                    className={CrudieStyle.PopupCancelBtn}
                    onClick={() => onDeleteCancel(selectedOneRowForDelete)}
                  >
                    Cancel
                  </button>
                </div>
        ...
        <>
          {selectedMultipleRowForDeletePopup && (
            <div className={CrudieStyle.modal}>
              <div className={CrudieStyle.modalcontent}>
                <h3>
                  Popup Delete , Are you sure want to delete id all selected
                  data.
                </h3>
                <h4>
        ...
        {datainPage && datainPage.length !== 0 && (
          <table>
            <tr>

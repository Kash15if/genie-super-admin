  ...
  if (inputType === "dropdown") {
    return (
      <>
        ...
        <select
          disabled={
            !(
              (col.createOnce && !selectedOneRowForEdit[col.column].length) ||
              col.editable
            )
          }
          name={col.column}
          id={col.column}
          value={selectedOneRowForEdit[col.column]}
          onChange={editFormContentChange}
        >
          {col.formInputDetails.data.map((item) => (
    ...
    return (
      <>
        ...
        <input
          ...
          value={selectedOneRowForEdit[col.column]}
          onChange={editFormContentChange}
          min={col.formInputDetails.data.min}
          max={col.formInputDetails.data.max}
        />
      </>
    );
    ...
    return (
      <>
        <label for={col.column}>{col.column}</label>
        <input
          disabled={!((col.createOnce && creatingNew) || col.editable)}
          name={col.column}
          id={col.column}
          value={selectedOneRowForEdit[col.column]}
          onChange={editFormContentChange}
